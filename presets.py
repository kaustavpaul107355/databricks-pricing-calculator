...
SCENARIO_PRESETS = {
    ...
    "Batch AI": {
        ...
        "M": {
            "label": "Medium (50K docs, weekly + extract)",
            "params": {
                "num_docs": 50_000,
                "pages_per_doc": 8,
                "parse_complexity": "Medium (text + tables + images, e.g. 10-Ks)",
        ...
        "L": {
            "label": "Large (500K docs, daily + extract + classify)",
            "params": {
                "num_docs": 500_000,
                "pages_per_doc": 10,
                "parse_complexity": "High (complex diagrams + captions)",
                ...
                "include_extract": True,
                "extract_workload": "Financial reports (12-15 pages)",
                "include_classify": True,
                "classify_workload": "Rental contracts (7-10 pages)",
            },
        },
    },
    "Fine-Tune": {
